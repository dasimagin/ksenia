...
class NTMHeadBase(nn.Module):
    ...
    def _address_memory(self, key, beta, gate, shift, gamma, w_prev):
        # Handle Activations
        key = key.clone()
        ...
        w = self.memory.address(key, beta, gate, shift, gamma, w_prev)
...
class NTMReadHead(NTMHeadBase):
    ...
    def forward(self, embeddings, w_prev):
        ...
        key, beta, gate, shift, gamma = _split_cols(o, self.read_lengths)
...
class NTMWriteHead(NTMHeadBase):
    ...
    def forward(self, embeddings, w_prev):
        ...
        key, beta, gate, shift, gamma, e, a = _split_cols(o, self.write_lengths)
